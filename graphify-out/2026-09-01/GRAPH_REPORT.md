...
## Corpus Check
- 221 files · ~396,756 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1697 nodes · 2898 edges · 87 communities (78 shown, 9 thin omitted)
- Extraction: 95% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 129 edges (avg confidence: 0.59)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ac2cd476`
...
Cohesion: 0.11
Nodes (20): composeServiceSteps(), peekTicketNumber(), aiServices, { buildCustomerStatus }, express, loadAssistantContext(), { pool }, router (+12 more)
...
Cohesion: 0.11
Nodes (25): AI Agent Instructions & Skills, graphify, Skills Resolution Priority, ui-ux-pro-max, web-design-guidelines, CLAUDE.md — Project Guidance, Graphify Knowledge Graph Tool, Priority Queueing (Senior/PWD/Pregnant) (+17 more)
...
### Community 19 - "database.js"
Cohesion: 0.15
Nodes (14): addColumnIfMissing(), addIndexIfMissing(), DEFAULT_SERVICES, DOCTOR_SEEDS, initDB(), LAB_SEEDS, mysql, pool (+6 more)
...
Cohesion: 0.12
Nodes (17): graphify, Add-Watch Reference (.agents), For /graphify add, For --watch, graphify reference: add a URL and watch a folder, Exports & Benchmark Reference (.agents), Graphify SKILL.md (.agents), Honesty Rules (+9 more)
...
Cohesion: 0.12
Nodes (16): ADMIN_ROLES, requireAdmin(), requireStaff(), STAFF_ROLES, aiServices, ANNOUNCEMENT_DEPARTMENT_NAMES, bcrypt, crypto (+8 more)
...
### Community 63 - "queue_automation.js"
Cohesion: 0.38
Nodes (6): calculateScore(), FRONT_DESK_STEP, getNextFromList(), getNextPatient(), { pool }, callNextAtStation()
...
## Knowledge Gaps
- **352 isolated node(s):** `axios`, `{ pool }`, `{ spawn }`, `path`, `fs` (+347 more)
