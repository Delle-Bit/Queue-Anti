# Graph Report - Attempt1  (2026-08-16)

## Corpus Check
- 52 files · ~59,950 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 526 nodes · 659 edges · 45 communities (33 shown, 12 thin omitted)
...
Cohesion: 0.10
Nodes (17): aiServices, axios, callMockAI(), checkAIToggle(), logAI(), { pool }, aiServices, bcrypt (+9 more)
...
## Knowledge Gaps
- **212 isolated node(s):** `axios`, `{ pool }`, `aiServices`, `mysql`, `name` (+207 more)
...
- **Why does `pool` connect `database.js` to `server.js`, `queue.js`, `auth.js`, `admin.js`, `queue_automation.js`, `packages.js`?**
