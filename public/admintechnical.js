...
// Identical to renderLabSequence in owner.js - both pages host the same service
// editor. Front Desk is rendered as a locked step 1: it is the cashier, so it is
// prepended to every service by the queue engine (composeServiceSteps in
